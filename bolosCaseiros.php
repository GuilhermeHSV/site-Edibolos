...
<?php 
// Criando a consulta com o bd
// O conteudo da pagina devera vir da consulta ao bd
//Consulta para puxar apenas produtos da area 1.
$query_rs_edi = "SELECT * FROM tb_produts WHERE tb_produts.ativo = 1 AND tb_produts.id_Area = 1  ORDER BY tb_produts.id_Produts DESC";
...
<head>
    ...
    <meta name="keywords" content="bolos,bolo,loja,doces,chocolate,chocolates,caseiros,confeitaria,sobremesas,cupcakes,encomendas,aniversario,festas,pote,brownie,edi,edibolos, caseiros"><!-- Palavras-chave para busca via motor de pesquisa -->
    ...
    <title>Edi Bolos - Bolos Caseiros</title><!-- Título da página -->
...
<div class="ws_bullets"> 
  <div> <!--start div prévia img do carrossel-->
   <a href="#" ><span><img src="galeria/data1/tooltips/carrossel_01.png" alt="Imagem do Carrossel um" title="Imagem do Carrossel um" width="230" height="80"></span>1</a>
   <a href="#" ><span><img src="galeria/data1/tooltips/carrossel_02.png" alt="Imagem do Carrossel dois" title="Imagem do Carrossel dois" width="230" height="80"></span>2</a>
   <a href="#" ><span><img src="galeria/data1/tooltips/carrossel_03.png" alt="Imagem do Carrossel três" title="Imagem do Carrossel três" width="230" height="80"></span>3</a>
   <a href="#" ><span><img src="galeria/data1/tooltips/carrossel_04.png" alt="Imagem do Carrossel três" title="Imagem do Carrossel três" width="230" height="80"></span>3</a>
  </div> <!--start div prévia img do carrossel-->
</div>
