...
<head>
    ...
    <title>Edi Bolos - Sobre</title><!--Título da página-->
  ...
  <div class="container-fluid mb-3">
    <div class="row">
        ...
        <div class="col-lg-6">
			<section>
           <div>
			   <h2 class="fonte-zero">Título: Quem é Edi Bolos?</h2>
          ...
          Amo meu trabalho e faço com o maior carinho  para que cada cliente sinta-se especial e possa compartilhar com as pessoas que ama a vida um pouco mais doce.</p>
			  				  <h2 class="fonte-zero">Texto Descritivo</h2>
            </div>
        </div> 
    </div>
</div>
