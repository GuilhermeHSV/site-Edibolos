...
//Consulta para puxar apenas produtos da area 3.
$query_rs_edi = "SELECT * FROM tb_produts WHERE tb_produts.ativo = 1 AND tb_produts.id_Area = 3  ORDER BY tb_produts.id_Produts DESC";
...
<head>
    ...
    <title>Edi Bolos - Slice Cakes</title><!-- Título da página -->
