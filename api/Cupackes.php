...
//Consulta para puxar apenas produtos da area 4.
$query_rs_edi = "SELECT * FROM tb_produts WHERE tb_produts.ativo = 1 AND tb_produts.id_Area = 4  ORDER BY tb_produts.id_Produts DESC";
...
<head>
    ...
    <title>Edi Bolos - Cupackes</title><!-- Título da página -->
